...
RUN_CMD="./xbuild3 $1 CORP=${BUILD_ARG__CORP} SERVER=${BUILD_ARG__SERVER} VER=${BUILD_ARG__VER} SUB=${BUILD_ARG__SUB} DTG_SERVER=gtrack_tool DTG_MODEL=choyoung AUTO_PKG=${BUILD_ARG__AUTO_PKG} $2"
